...
Ниже — компоненты **в соответствии с текущим кодом** репозитория (без WebSocket/Channels: их нет в зависимостях и в `asgi.py`).
...
### 1.4. Что пойдёт в следующие разделы документа
